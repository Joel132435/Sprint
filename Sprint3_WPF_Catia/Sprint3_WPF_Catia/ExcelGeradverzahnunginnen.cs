...
{
    class ExcelGeradverzahnunginnen
    {
        ...
        internal void ExcelEinstellungen()
        {
            ...
            mySheet.Cells[4, "A"] = "Stirnrad Geradverzahnung Innen";
        ...
        internal void Geradverzahnunginnen(GeradverzahnunginnenBerechnung GeiZahn)
        {
            //übertragung in excel der ein und ausgabeparameter
            //Material hinzufügen

            mySheet.Cells[5, "c"] = GeiZahn.Modul;
            mySheet.Cells[6, "c"] = GeiZahn.Zähnezahl;
            mySheet.Cells[7, "c"] = GeiZahn.Teilkreisdurchmesser;
            mySheet.Cells[8, "c"] = GeiZahn.Breite;
            mySheet.Cells[9, "c"] = GeiZahn.Eingriffswinkel;
            mySheet.Cells[10, "c"] = GeiZahn.Kopfspiel;

            mySheet.Cells[13, "c"] = GeiZahn.Zahnhöhe;
            mySheet.Cells[14, "c"] = GeiZahn.Zahnfußhöhe;
            mySheet.Cells[15, "c"] = GeiZahn.Zahnkopfhöhe;
            mySheet.Cells[16, "c"] = GeiZahn.Teilung;
            mySheet.Cells[17, "c"] = GeiZahn.Fußkreisdurchmesser;
            mySheet.Cells[18, "c"] = GeiZahn.Grundkreisdurchmesser;
            mySheet.Cells[19, "c"] = GeiZahn.Kopfkreisdurchmesser;
