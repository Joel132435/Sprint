...
namespace Sprint3_WPF_Catia
{
    class ExcelPfeilverzahnung
    {
        ...
        internal void Pfeilverzahnung(PfeilverzahnungBerechnung PfZahn)
        {
            ...
            mySheet.Cells[5, "c"] = PfZahn.Modul;
            mySheet.Cells[6, "c"] = PfZahn.Zähnezahl;
            ...
            mySheet.Cells[15, "c"] = PfZahn.Zahnkopfhöhe;
            mySheet.Cells[16, "c"] = PfZahn.Teilung;
            mySheet.Cells[17, "c"] = PfZahn.Fußkreisdurchmesser;
            mySheet.Cells[18, "c"] = PfZahn.Grundkreisdurchmesser;
            mySheet.Cells[19, "c"] = PfZahn.Kopfkreisdurchmesser;
